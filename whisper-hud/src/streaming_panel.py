...
try:
    from AppKit import (
        ...
        NSScrollView, NSTextView, NSBezelBorder,
    ...
    HAS_APPKIT = False
    print("Warning: PyObjC not available, streaming panel will use console")
...
class ConsoleStreamingPanel:
    ...
    def show_transcribing(self, show_translation: bool = False):
        if self._enabled:
            print("[StreamingPanel] Transcribing...")
    ...
    def show_translating(self):
        if self._enabled:
            print("[StreamingPanel] Translating...")
        self._state = StreamingPanelState.TRANSLATING
