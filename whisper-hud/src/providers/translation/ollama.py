...
class OllamaTranslateProvider(TranslationProvider):
    ...
    def _build_prompt(self, text: str, source_lang: str, target_lang: str) -> str:
        ...
        # Get full language names for clearer prompts
...
Translate the following text from {source_name} to {target_name}. Output ONLY the translation, nothing else.
    ...
    def download_model(self, progress_callback: Optional[Callable[[str], None]] = None) -> bool:
        ...
        try:
            process = subprocess.Popen(
                ["ollama", "pull", self.model_config["ollama_name"]],
